...
Shader "CustomFX/N/Scroll"
{
	Properties
	{
		...
		_Scroll_Texture("Scroll_Texture", 2D) = "white" {}
		[ASEEnd]_Power("Power", Float) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 texCoord12 = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult30 = smoothstep( 0.8 , 0.9 , texCoord12.x);
				float3 texCoord19 = IN.ase_texcoord3.xyz;
				texCoord19.xy = IN.ase_texcoord3.xyz.xy * float2( 2,2 ) + float2( 0,0 );
				float4 appendResult41 = (float4(texCoord19.z , 0.0 , 0.0 , 0.0));
				float2 panner18 = ( 1.0 * _Time.y * appendResult41.xy + texCoord19.xy);
				float temp_output_39_0 = saturate( ( ( 1.0 - smoothstepResult30 ) * tex2D( _Texture, ( texCoord12 + ( tex2D( _Scroll_Texture, panner18 ).r * _Power ) ) ).r * 1.0 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * temp_output_39_0 ).rgb;
				float Alpha = ( IN.ase_color.a * temp_output_39_0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord12 = IN.ase_texcoord2.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult30 = smoothstep( 0.8 , 0.9 , texCoord12.x);
				float3 texCoord19 = IN.ase_texcoord2.xyz;
				texCoord19.xy = IN.ase_texcoord2.xyz.xy * float2( 2,2 ) + float2( 0,0 );
				float4 appendResult41 = (float4(texCoord19.z , 0.0 , 0.0 , 0.0));
				float2 panner18 = ( 1.0 * _Time.y * appendResult41.xy + texCoord19.xy);
				float temp_output_39_0 = saturate( ( ( 1.0 - smoothstepResult30 ) * tex2D( _Texture, ( texCoord12 + ( tex2D( _Scroll_Texture, panner18 ).r * _Power ) ) ).r * 1.0 ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord12 = IN.ase_texcoord.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult30 = smoothstep( 0.8 , 0.9 , texCoord12.x);
				float3 texCoord19 = IN.ase_texcoord.xyz;
				texCoord19.xy = IN.ase_texcoord.xyz.xy * float2( 2,2 ) + float2( 0,0 );
				float4 appendResult41 = (float4(texCoord19.z , 0.0 , 0.0 , 0.0));
				float2 panner18 = ( 1.0 * _Time.y * appendResult41.xy + texCoord19.xy);
				float temp_output_39_0 = saturate( ( ( 1.0 - smoothstepResult30 ) * tex2D( _Texture, ( texCoord12 + ( tex2D( _Scroll_Texture, panner18 ).r * _Power ) ) ).r * 1.0 ) );
				
				surfaceDescription.Alpha = ( IN.ase_color.a * temp_output_39_0 );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord12 = IN.ase_texcoord1.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult30 = smoothstep( 0.8 , 0.9 , texCoord12.x);
				float3 texCoord19 = IN.ase_texcoord1.xyz;
				texCoord19.xy = IN.ase_texcoord1.xyz.xy * float2( 2,2 ) + float2( 0,0 );
				float4 appendResult41 = (float4(texCoord19.z , 0.0 , 0.0 , 0.0));
				float2 panner18 = ( 1.0 * _Time.y * appendResult41.xy + texCoord19.xy);
				float temp_output_39_0 = saturate( ( ( 1.0 - smoothstepResult30 ) * tex2D( _Texture, ( texCoord12 + ( tex2D( _Scroll_Texture, panner18 ).r * _Power ) ) ).r * 1.0 ) );
...
/*ASEBEGIN
Version=18935
2177;93;1412;894;1818.051;444.326;1.296857;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-1793.641,58.12749;Inherit;False;0;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;2,2;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;41;-1577.446,205.6693;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.PannerNode;18;-1435.441,126.4275;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1081.726,278.0939;Inherit;False;Property;_Power;Power;2;0;Create;True;0;0;0;False;0;False;0.1;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;-1253.636,81.5762;Inherit;True;Property;_Scroll_Texture;Scroll_Texture;1;0;Create;True;0;0;0;False;0;False;-1;cac067924325069479a9e9a04f354f5b;d0aa1c167dda1954f843d6840fea526c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-918.7261,155.0939;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-1078.203,-61.32628;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;13;-779.7261,71.09393;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SmoothstepOpNode;30;-845.1198,-264.8343;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;0.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;31;-621.5295,-263.1423;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;42;-647.9463,11.96923;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;a969082f57ce9a44ebd623c7072e2d3f;a969082f57ce9a44ebd623c7072e2d3f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-489.075,353.826;Inherit;False;Constant;_Float1;Float 1;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-335.7946,17.80104;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;33;-135.9296,-231.7744;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;39;-131.0571,10.44267;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;56.07044,-119.7744;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;72.07044,88.22556;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;259.543,-52.90982;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;CustomFX/N/Scroll;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638027137576606746;  Blend;0;0;Two Sided;0;638027152902268708;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
WireConnection;2;3;35;0
ASEEND*/
//CHKSM=D0E71588EEDAAF6A69B51AAE4F5BA77E51A919EF