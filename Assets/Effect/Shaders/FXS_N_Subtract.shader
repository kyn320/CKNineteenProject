	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_Texture = IN.ase_texcoord3.xyz.xy * _Texture_ST.xy + _Texture_ST.zw;
				float3 texCoord19 = IN.ase_texcoord3.xyz;
				texCoord19.xy = IN.ase_texcoord3.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Intensity * IN.ase_color * _Color ).rgb;
				float Alpha = ( IN.ase_color.a * saturate( ( tex2D( _Texture, uv_Texture ).r - (( _ToggleSwitch0 )?( texCoord19.z ):( _Dissolve )) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				texCoord19.xy = IN.ase_texcoord2.xyz.xy * float2( 1,1 ) + float2( 0,0 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Texture = IN.ase_texcoord.xyz.xy * _Texture_ST.xy + _Texture_ST.zw;
				float3 texCoord19 = IN.ase_texcoord.xyz;
				texCoord19.xy = IN.ase_texcoord.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				
				surfaceDescription.Alpha = ( IN.ase_color.a * saturate( ( tex2D( _Texture, uv_Texture ).r - (( _ToggleSwitch0 )?( texCoord19.z ):( _Dissolve )) ) ) );
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Texture = IN.ase_texcoord1.xyz.xy * _Texture_ST.xy + _Texture_ST.zw;
				float3 texCoord19 = IN.ase_texcoord1.xyz;
				texCoord19.xy = IN.ase_texcoord1.xyz.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=18935
2224;75;1412;894;1247.268;244.3258;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;15;-914.1775,351.3434;Inherit;False;Property;_Dissolve;Dissolve;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-880.9634,450.541;Inherit;False;0;-1;3;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-702.9774,136.5434;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;0ab15e10fbded684f817cd419e7d9132;0ab15e10fbded684f817cd419e7d9132;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;18;-626.9634,376.541;Inherit;False;Property;_ToggleSwitch0;Toggle Switch0;1;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;13;-388.3775,179.7434;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;25;-349.5933,-169.7655;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;24;-164.9933,152.6345;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;12.737,126.941;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-3.793298,-182.7655;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-343.0932,-273.7653;Inherit;False;Property;_Intensity;Intensity;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;28;-384.6935,-460.9653;Inherit;False;Property;_Color;Color;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;163.8,2.600001;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;CustomFX/N/Subtract;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638026458582563751;  Blend;0;638026466708046002;Two Sided;1;0;Cast Shadows;0;638026465921530345;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=F404FCDE9B4D5A307B35ED3E5D4FB11A003216FC