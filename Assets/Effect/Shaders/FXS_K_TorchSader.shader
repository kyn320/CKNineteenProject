	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#ifdef _KEYWORD0_ON
				float staticSwitch22 = IN.ase_texcoord3.z;
				#else
				float staticSwitch22 = _DIss_Step;
				#endif
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _TintColor * IN.ase_color * _Main_Ins ).rgb;
				float Alpha = saturate( ( tex2D( _MainTex, uv_MainTex ).r * step( tex2D( _DissTex, uv_DissTex ).r , staticSwitch22 ) * IN.ase_color.a ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#ifdef _KEYWORD0_ON
				float staticSwitch22 = IN.ase_texcoord2.z;
				#else
				float staticSwitch22 = _DIss_Step;
				#endif
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				#ifdef _KEYWORD0_ON
				float staticSwitch22 = IN.ase_texcoord.z;
				#else
				float staticSwitch22 = _DIss_Step;
				#endif
				
				surfaceDescription.Alpha = saturate( ( tex2D( _MainTex, uv_MainTex ).r * step( tex2D( _DissTex, uv_DissTex ).r , staticSwitch22 ) * IN.ase_color.a ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				#ifdef _KEYWORD0_ON
				float staticSwitch22 = IN.ase_texcoord1.z;
				#else
				float staticSwitch22 = _DIss_Step;
				#endif
...
/*ASEBEGIN
Version=18935
0;2;1920;1017;1378;327.5;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;16;-976,525.5;Inherit;False;Property;_DIss_Step;DIss_Step;2;0;Create;True;0;0;0;False;0;False;0.1329412;0.654;-0.1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;21;-1391,211.5;Inherit;True;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-979,293.5;Inherit;True;Property;_DissTex;DissTex;1;0;Create;True;0;0;0;False;0;False;-1;97bce6c3a3e547047af626db90f2886f;97bce6c3a3e547047af626db90f2886f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;22;-1236,486.5;Inherit;False;Property;_Keyword0;Keyword 0;4;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;-859,-34.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;8ef52fe1e8b48e046be630235658eb1a;8ef52fe1e8b48e046be630235658eb1a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;15;-673,323.5;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;19;-391,-0.5;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-328,189.5;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;18;-457,-219.5;Inherit;False;Property;_TintColor;TintColor;3;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;2.324507,2.324507,2.324507,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;24;-479,-49.5;Inherit;False;Property;_Main_Ins;Main_Ins;5;0;Create;True;0;0;0;False;0;False;0;1;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;23;-94,198.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-168,-130.5;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;4;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;CustomFX/K/Torchshader;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637996266432584991;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;637996266460138223;  Use Shadow Threshold;0;0;Receive Shadows;0;637996266464881461;GPU Instancing;0;637996266467539925;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
WireConnection;4;3;23;0
ASEEND*/
//CHKSM=18B9EAAA51513191C82B3426CAC7ACADAA07D69F