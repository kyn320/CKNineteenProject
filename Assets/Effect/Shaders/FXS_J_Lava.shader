	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( ( _Tint_Color * float4( ( pow( (tex2D( _Main_Texture, uv_Main_Texture )).rgb , temp_cast_0 ) * staticSwitch12 ) , 0.0 ) ) * IN.ase_color ) * IN.ase_color.a ).rgb;
				float Alpha = 1;
...
ASEEND*/
//CHKSM=B70D0EA07F5FC18F8A6265056F28DE40F10ADAE5