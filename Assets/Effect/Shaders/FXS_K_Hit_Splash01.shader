...
Shader "CustomFX/K/FXS_K_Hit_Splash01"
{
	Properties
	{
		...
		_Diss_Step("Diss_Step", Range( 0 , 1)) = 0
		[Toggle(_USE_CUSTOM_ON)] _Use_Custom("Use_Custom", Float) = 0
		[Toggle(_USE_CUSTOM1_ON)] _Use_Custom1("Use_Custom", Float) = 0
		[ASEEnd][HDR]_TintColor("TintColor", Color) = (1,0.7872481,0.0518868,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_DissTex = IN.ase_texcoord3.xy * _DissTex_ST.xy + _DissTex_ST.zw;
				#ifdef _USE_CUSTOM1_ON
				float staticSwitch39 = IN.ase_texcoord3.w;
				#else
				float staticSwitch39 = 6.53;
				#endif
				float cos36 = cos( staticSwitch39 );
				float sin36 = sin( staticSwitch39 );
				float2 rotator36 = mul( uv_DissTex - float2( 0.5,0.5 ) , float2x2( cos36 , -sin36 , sin36 , cos36 )) + float2( 0.5,0.5 );
				#ifdef _USE_CUSTOM_ON
				float staticSwitch28 = IN.ase_texcoord3.z;
				#else
				float staticSwitch28 = _Diss_Step;
				#endif
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _TintColor * IN.ase_color ).rgb;
				float Alpha = saturate( ( IN.ase_color.a * saturate( ( tex2D( _MainTex, uv_MainTex ).r * ( 1.0 - step( saturate( ( tex2D( _DissTex, rotator36 ).r + 0.001 ) ) , staticSwitch28 ) ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_DissTex = IN.ase_texcoord2.xy * _DissTex_ST.xy + _DissTex_ST.zw;
				#ifdef _USE_CUSTOM1_ON
				...
				float2 rotator36 = mul( uv_DissTex - float2( 0.5,0.5 ) , float2x2( cos36 , -sin36 , sin36 , cos36 )) + float2( 0.5,0.5 );
				#ifdef _USE_CUSTOM_ON
				float staticSwitch28 = IN.ase_texcoord2.z;
				#else
				float staticSwitch28 = _Diss_Step;
				#endif
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_DissTex = IN.ase_texcoord.xy * _DissTex_ST.xy + _DissTex_ST.zw;
				#ifdef _USE_CUSTOM1_ON
				...
				float2 rotator36 = mul( uv_DissTex - float2( 0.5,0.5 ) , float2x2( cos36 , -sin36 , sin36 , cos36 )) + float2( 0.5,0.5 );
				#ifdef _USE_CUSTOM_ON
				float staticSwitch28 = IN.ase_texcoord.z;
				#else
				float staticSwitch28 = _Diss_Step;
				#endif
				
				surfaceDescription.Alpha = saturate( ( IN.ase_color.a * saturate( ( tex2D( _MainTex, uv_MainTex ).r * ( 1.0 - step( saturate( ( tex2D( _DissTex, rotator36 ).r + 0.001 ) ) , staticSwitch28 ) ) ) ) ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_DissTex = IN.ase_texcoord1.xy * _DissTex_ST.xy + _DissTex_ST.zw;
				#ifdef _USE_CUSTOM1_ON
				...
				float2 rotator36 = mul( uv_DissTex - float2( 0.5,0.5 ) , float2x2( cos36 , -sin36 , sin36 , cos36 )) + float2( 0.5,0.5 );
				#ifdef _USE_CUSTOM_ON
				float staticSwitch28 = IN.ase_texcoord1.z;
				#else
				float staticSwitch28 = _Diss_Step;
				#endif
...
/*ASEBEGIN
Version=18935
0;-2;1920;1021;1145.339;343.7193;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;38;-1949.026,352.9085;Inherit;False;Constant;_Rotator;Rotator;5;0;Create;True;0;0;0;False;0;False;6.53;0;0;7;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;27;-1202.878,588.77;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-1949.489,59.00768;Inherit;False;0;11;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;39;-883.025,685.709;Inherit;False;Property;_Use_Custom1;Use_Custom;4;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;36;-1704.625,77.30872;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;11;-1452.29,70.2075;Inherit;True;Property;_DissTex;DissTex;1;0;Create;True;0;0;0;False;0;False;-1;07178f2e45bf28b4daf3e003c689c50a;f862f97ef17a2504c953a715421baf56;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;22;-799.79,378.9078;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;0.001;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-951.8898,520.0079;Inherit;False;Property;_Diss_Step;Diss_Step;2;0;Create;True;0;0;0;False;0;False;0;0.282353;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;21;-682.5898,270.9078;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;28;-648.7783,515.07;Inherit;False;Property;_Use_Custom;Use_Custom;3;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;35;-561.778,258.07;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;15;-409.8897,247.0077;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;17;-272.39,245.0076;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-395.3899,56.10759;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;e6784ee10a8ecc74b8ee80354dbc3122;ff590ded55b0c2b499b15977a197a9ca;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-91.0896,191.8076;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;40;115.6437,190.8827;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;41;-86.35596,-5.11731;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;269.644,148.8827;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;23;-136.4471,-185.2419;Inherit;False;Property;_TintColor;TintColor;5;1;[HDR];Create;True;0;0;0;False;0;False;1,0.7872481,0.0518868,0;1.939726,1.630875,0.5947275,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;102.644,-12.11731;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;44;422.6613,147.2807;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;557,103;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;CustomFX/K/FXS_K_Hit_Splash01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638015129655411191;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;638015129670727291;  Use Shadow Threshold;0;0;Receive Shadows;0;638015129663349866;GPU Instancing;0;638015129675704165;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
WireConnection;39;1;38;0
WireConnection;39;0;27;4
...
ASEEND*/
//CHKSM=22EC55486FB2A8632440AB6035BE892BDFB13B97