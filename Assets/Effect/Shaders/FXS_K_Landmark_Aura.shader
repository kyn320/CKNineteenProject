...
Shader "CustomFX/K/Landmark_Aura01/"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Main_Pow("Main_Pow", Range( 1 , 100)) = 1
		_Main_Mult("Main_Mult", Range( 1 , 10)) = 1
		[HDR]_TintColor("TintColor", Color) = (1,1,1,0)
		_SubTex("SubTex", 2D) = "white" {}
		_Sub_Vpanner("Sub_Vpanner", Range( -1 , 1)) = 0
		_Sub_Pow("Sub_Pow", Range( 1 , 10)) = 0
		_Sub_Mult("Sub_Mult", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_13_0 = ( pow( ( 1.0 - texCoord11.y ) , _Main_Pow ) * _Main_Mult );
				float2 appendResult26 = (float2(0.0 , _Sub_Vpanner));
				float2 uv_SubTex = IN.ase_texcoord3.xy * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 panner25 = ( 1.0 * _Time.y * appendResult26 + uv_SubTex);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _TintColor * IN.ase_color ).rgb;
				float Alpha = ( IN.ase_color.a * saturate( ( temp_output_13_0 * saturate( ( temp_output_13_0 + ( pow( tex2D( _SubTex, panner25 ).r , _Sub_Pow ) * _Sub_Mult ) ) ) ) ) * _Opacity );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_13_0 = ( pow( ( 1.0 - texCoord11.y ) , _Main_Pow ) * _Main_Mult );
				float2 appendResult26 = (float2(0.0 , _Sub_Vpanner));
				float2 uv_SubTex = IN.ase_texcoord2.xy * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 panner25 = ( 1.0 * _Time.y * appendResult26 + uv_SubTex);
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_13_0 = ( pow( ( 1.0 - texCoord11.y ) , _Main_Pow ) * _Main_Mult );
				float2 appendResult26 = (float2(0.0 , _Sub_Vpanner));
				float2 uv_SubTex = IN.ase_texcoord.xy * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 panner25 = ( 1.0 * _Time.y * appendResult26 + uv_SubTex);
				
				surfaceDescription.Alpha = ( IN.ase_color.a * saturate( ( temp_output_13_0 * saturate( ( temp_output_13_0 + ( pow( tex2D( _SubTex, panner25 ).r , _Sub_Pow ) * _Sub_Mult ) ) ) ) ) * _Opacity );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_13_0 = ( pow( ( 1.0 - texCoord11.y ) , _Main_Pow ) * _Main_Mult );
				float2 appendResult26 = (float2(0.0 , _Sub_Vpanner));
				float2 uv_SubTex = IN.ase_texcoord1.xy * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 panner25 = ( 1.0 * _Time.y * appendResult26 + uv_SubTex);
...
/*ASEBEGIN
Version=18935
0;-2;1920;1021;846.327;373.8011;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;28;-1365.281,645.6378;Inherit;False;Property;_Sub_Vpanner;Sub_Vpanner;4;0;Create;True;0;0;0;False;0;False;0;-0.61;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;24;-1219,408.5;Inherit;False;0;23;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;26;-1090.281,559.6378;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;25;-963,418.5;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-1088,-49.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-995,121.5;Inherit;False;Property;_Main_Pow;Main_Pow;0;0;Create;True;0;0;0;False;0;False;1;2.6;1;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;23;-733,398.5;Inherit;True;Property;_SubTex;SubTex;3;0;Create;True;0;0;0;False;0;False;-1;None;19a86e533e3d4bb4096d1b4e3a9314bd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-622.2815,624.6378;Inherit;False;Property;_Sub_Pow;Sub_Pow;5;0;Create;True;0;0;0;False;0;False;0;1;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;16;-871,3.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-308.2815,636.6378;Inherit;False;Property;_Sub_Mult;Sub_Mult;6;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;29;-381.2815,459.6378;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;12;-698,-23.5;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-731,205.5;Inherit;False;Property;_Main_Mult;Main_Mult;1;0;Create;True;0;0;0;False;0;False;1;1;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-203.2815,466.6378;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-427,7.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;33;-119.2815,161.6378;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;36;-49.541,392.4086;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;102.459,136.4086;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;138.673,391.1989;Inherit;False;Property;_Opacity;Opacity;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;17;227,20.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;19;-297,-176.5;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;395.7185,7.637848;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;18;-354,-346.5;Inherit;False;Property;_TintColor;TintColor;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0.7244357,1.490268,1.976675,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-109,-214.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;626,-8;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;CustomFX/K/Landmark_Aura01/;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638005322197792651;  Blend;0;0;Two Sided;0;638005322218313922;Cast Shadows;0;638005322230848518;  Use Shadow Threshold;0;0;Receive Shadows;0;638005322227414599;GPU Instancing;0;638005322225100994;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=A291C8893453482D4CB35050E3BFA5A58D7826D0