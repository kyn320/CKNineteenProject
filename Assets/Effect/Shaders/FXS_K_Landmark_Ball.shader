...
Shader "CustomFX/K/Landmark_Bal01"
{
	Properties
	{
		...
		_Fres_Scale("Fres_Scale", Range( 1 , 10)) = 1
		_Fres_Power("Fres_Power", Range( 1 , 10)) = 1
		_Noise_Vpanner01("Noise_Vpanner01", Range( -0.5 , 0)) = 0.06
		_Noise_Vpanner02("Noise_Vpanner02", Range( -0.5 , 0)) = 0.06
		[HDR]_Tintcolor("Tintcolor", Color) = (1,1,1,0)
		_Noise_Upanner02("Noise_Upanner02", Range( -0.5 , 0.5)) = 0
		_Noise_Upanner01("Noise_Upanner01", Range( -0.5 , 0.5)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Tintcolor;
			float4 _NoiseTex_ST;
			float _Noise_Upanner01;
			float _Noise_Vpanner01;
			float _Fres_Scale;
			float _Fres_Power;
			float _Noise_Upanner02;
			float _Noise_Vpanner02;
			float _Opacity;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 appendResult20 = (float2(_Noise_Upanner01 , _Noise_Vpanner01));
				...
				float fresnelNode11 = ( 0.0 + _Fres_Scale * pow( 1.0 - fresnelNdotV11, _Fres_Power ) );
				float2 appendResult28 = (float2(_Noise_Upanner02 , _Noise_Vpanner02));
				float2 panner29 = ( 1.0 * _Time.y * appendResult28 + uv_NoiseTex);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = _Tintcolor.rgb;
				float Alpha = ( saturate( ( saturate( ( saturate( ( tex2D( _NoiseTex, panner17 ).r + saturate( fresnelNode11 ) + tex2D( _NoiseTex, panner29 ).r ) ) * fresnelNode11 ) ) * IN.ase_color.a ) ) * _Opacity );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( saturate( ( saturate( ( saturate( ( tex2D( _NoiseTex, panner17 ).r + saturate( fresnelNode11 ) + tex2D( _NoiseTex, panner29 ).r ) ) * fresnelNode11 ) ) * IN.ase_color.a ) ) * _Opacity );
...
/*ASEBEGIN
Version=18935
0;-2;1920;1021;999.5615;213.659;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;19;-1459,132.5;Inherit;False;Property;_Noise_Vpanner01;Noise_Vpanner01;3;0;Create;True;0;0;0;False;0;False;0.06;0;-0.5;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-1533.827,595.634;Inherit;False;Property;_Noise_Upanner02;Noise_Upanner02;6;0;Create;True;0;0;0;False;0;False;0;-0.016;-0.5;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-1504.827,50.63403;Inherit;False;Property;_Noise_Upanner01;Noise_Upanner01;7;0;Create;True;0;0;0;False;0;False;0;0.028;-0.5;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-1524.25,679.25;Inherit;False;Property;_Noise_Vpanner02;Noise_Vpanner02;4;0;Create;True;0;0;0;False;0;False;0.06;-0.07500001;-0.5;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-1283,-70.5;Inherit;False;0;10;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;26;-1360.25,440.25;Inherit;False;0;10;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;20;-1159,105.5;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1172,353.5;Inherit;False;Property;_Fres_Power;Fres_Power;2;0;Create;True;0;0;0;False;0;False;1;1.76;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1171,273.5;Inherit;False;Property;_Fres_Scale;Fres_Scale;1;0;Create;True;0;0;0;False;0;False;1;3.09;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;28;-1236.25,616.25;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;29;-1107.25,454.25;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;17;-1030,-56.5;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FresnelNode;11;-884,172.5;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-838,-78.5;Inherit;True;Property;_NoiseTex;NoiseTex;0;0;Create;True;0;0;0;False;0;False;-1;f862f97ef17a2504c953a715421baf56;f862f97ef17a2504c953a715421baf56;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;25;-873,478.5;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;10;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;22;-593,131.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;14;-444,102.5;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;23;-271,36.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-194,147.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;24;3,158.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;32;-93.83606,429.0149;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;163.5639,244.415;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;36;212.4385,402.341;Inherit;False;Property;_Opacity;Opacity;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;35;289.664,208.0149;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;21;-345,-142.5;Inherit;False;Property;_Tintcolor;Tintcolor;5;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1.401534,2.930479,6.498019,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;426.4385,233.341;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;473,-34;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;CustomFX/K/Landmark_Bal01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638003781972332595;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;638003781981120381;  Use Shadow Threshold;0;0;Receive Shadows;0;638003781986281187;GPU Instancing;0;638003781983763498;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=3A33833662F29117C8B7DC8CAAA58198F523D20A