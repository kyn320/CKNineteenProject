...
Shader "FXS_K_Landmark_Complete_Line01"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Line_Power("Line_Power", Range( 1 , 1000)) = 1
		_Line_Mult("Line_Mult", Range( 1 , 100)) = 1
		[HDR]_Tintcolor("Tintcolor", Color) = (1,1,1,0)
		_DissTex("DissTex", 2D) = "white" {}
		_Main_inten("Main_inten", Range( 1 , 20)) = 0
		_Diss("Diss", Range( -1 , 1)) = 0
		[ASEEnd][Toggle(_CUSTOM_ON_ON)] _Custom_on("Custom_on", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _CUSTOM_ON_ON
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#ifdef _CUSTOM_ON_ON
				float staticSwitch36 = IN.ase_texcoord3.z;
				#else
				float staticSwitch36 = _Diss;
				#endif
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Tintcolor * IN.ase_color * _Main_inten ).rgb;
				float Alpha = ( saturate( ( ( pow( saturate( ( ( 1.0 - texCoord10.y ) * texCoord10.y * 4.0 ) ) , _Line_Power ) * _Line_Mult ) * saturate( ( tex2D( _DissTex, uv_DissTex ).r + staticSwitch36 ) ) ) ) * IN.ase_color.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#ifdef _CUSTOM_ON_ON
				float staticSwitch36 = IN.ase_texcoord2.z;
				#else
				float staticSwitch36 = _Diss;
				#endif
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				#ifdef _CUSTOM_ON_ON
				float staticSwitch36 = IN.ase_texcoord.z;
				#else
				float staticSwitch36 = _Diss;
				#endif
				
				surfaceDescription.Alpha = ( saturate( ( ( pow( saturate( ( ( 1.0 - texCoord10.y ) * texCoord10.y * 4.0 ) ) , _Line_Power ) * _Line_Mult ) * saturate( ( tex2D( _DissTex, uv_DissTex ).r + staticSwitch36 ) ) ) ) * IN.ase_color.a );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				#ifdef _CUSTOM_ON_ON
				float staticSwitch36 = IN.ase_texcoord1.z;
				#else
				float staticSwitch36 = _Diss;
				#endif
...
/*ASEBEGIN
Version=18935
0;-2;1920;1021;1316.986;-105.2925;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-999,-45.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-790,52.5;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;12;-784,-48.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-633,-35.5;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;22;-668.3215,510.3497;Inherit;False;0;21;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexCoordVertexDataNode;35;-570.9994,754.7976;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;33;-300.322,742.3497;Inherit;False;Property;_Diss;Diss;5;0;Create;True;0;0;0;False;0;False;0;1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;21;-434.9798,488.8972;Inherit;True;Property;_DissTex;DissTex;3;0;Create;True;0;0;0;False;0;False;-1;008113766d59ed24a863a2aeb2dd27d0;a8a0e4bd2d50ed6408db991b54279708;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;36;-301.9856,865.2925;Inherit;False;Property;_Custom_on;Custom_on;6;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;15;-399,-17.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-480,73.5;Inherit;False;Property;_Line_Power;Line_Power;0;0;Create;True;0;0;0;False;0;False;1;1000;1;1000;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-253,233.5;Inherit;False;Property;_Line_Mult;Line_Mult;1;0;Create;True;0;0;0;False;0;False;1;1;1;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;32;-64.32202,571.3497;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;14;-203,-12.5;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;17,3.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;34;74.67798,571.3497;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;230.6785,382.3497;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;19;226,-14.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;27;-122.3215,-243.6503;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;28;45.67853,-137.6503;Inherit;False;Property;_Main_inten;Main_inten;4;0;Create;True;0;0;0;False;0;False;0;20;1;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;306.6785,-252.6503;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;20;55,-353.5;Inherit;False;Property;_Tintcolor;Tintcolor;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0.3686275,0.454902,2,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;379.6785,-2.650299;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;519,-67;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;FXS_K_Landmark_Complete_Line01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638003941174661025;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;638003941192280461;  Use Shadow Threshold;0;0;Receive Shadows;0;638003941195716908;GPU Instancing;0;638003941198105706;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=5D7EDFC47E06A26AE4696ED17EFEC40B4B318D11