...
Shader "FXS_K_Potion_Helix"
{
	Properties
	{
		...
		_Main_Mult("Main_Mult", Range( 1 , 100)) = 4.494118
		[HDR]_FrontColor("FrontColor", Color) = (0.3443396,0.9805411,1,0)
		[HDR]_BackColor("BackColor", Color) = (0.3443396,0.9805411,1,0)
		_Frontins("Frontins", Range( 1 , 10)) = 1
		_Backins("Backins", Range( 1 , 10)) = 1
		_Main_VOffset("Main_VOffset", Range( -1 , 2)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float4 switchResult38 = (((ase_vface>0)?(( _FrontColor * _Frontins )):(( _BackColor * _Backins ))));
				
				float2 uv_MainTex = IN.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				#ifdef _KEYWORD0_ON
				float staticSwitch43 = IN.ase_texcoord3.z;
				#else
				float staticSwitch43 = _Main_VOffset;
				#endif
				float2 appendResult31 = (float2(0.0 , staticSwitch43));
				float2 texCoord17 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = switchResult38.rgb;
				float Alpha = saturate( ( saturate( ( pow( tex2D( _MainTex, (uv_MainTex*1.0 + appendResult31) ).r , _Main_Pow ) * _Main_Mult ) ) * ( ( 1.0 - texCoord17.y ) * texCoord17.y * 5.17 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#ifdef _KEYWORD0_ON
				float staticSwitch43 = IN.ase_texcoord2.z;
				#else
				float staticSwitch43 = _Main_VOffset;
				#endif
				float2 appendResult31 = (float2(0.0 , staticSwitch43));
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				#ifdef _KEYWORD0_ON
				float staticSwitch43 = IN.ase_texcoord.z;
				#else
				float staticSwitch43 = _Main_VOffset;
				#endif
				float2 appendResult31 = (float2(0.0 , staticSwitch43));
				...
				surfaceDescription.Alpha = saturate( ( saturate( ( pow( tex2D( _MainTex, (uv_MainTex*1.0 + appendResult31) ).r , _Main_Pow ) * _Main_Mult ) ) * ( ( 1.0 - texCoord17.y ) * texCoord17.y * 5.17 ) ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				#ifdef _KEYWORD0_ON
				float staticSwitch43 = IN.ase_texcoord1.z;
				#else
				float staticSwitch43 = _Main_VOffset;
				#endif
				float2 appendResult31 = (float2(0.0 , staticSwitch43));
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;2300.295;634.5786;1.6;True;True
Node;AmplifyShaderEditor.TexCoordVertexDataNode;42;-1627.976,237.6928;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-1713.444,155.1573;Inherit;False;Property;_Main_VOffset;Main_VOffset;7;0;Create;True;0;0;0;False;0;False;0;0.06;-1;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-1370.6,98.10007;Inherit;False;Constant;_Float2;Float 2;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;43;-1440.176,171.1928;Inherit;False;Property;_Keyword0;Keyword 0;8;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;31;-1242.6,95.1;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;28;-1336,-40.5;Inherit;False;0;10;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScaleAndOffsetNode;27;-1081,-23.5;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-781,161.5;Inherit;False;Property;_Main_Pow;Main_Pow;1;0;Create;True;0;0;0;False;0;False;1;1;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-789,-50.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;2bcf168789b827c4a86d5668e95c04b4;2bcf168789b827c4a86d5668e95c04b4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-628,255.5;Inherit;False;Property;_Main_Mult;Main_Mult;2;0;Create;True;0;0;0;False;0;False;4.494118;100;1;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-642,361.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;12;-480,-3.5;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-326,-0.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-398.697,506.7908;Inherit;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;0;False;0;False;5.17;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;33;-384.697,391.7908;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-199.697,401.7908;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;15;-96,22.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-36.69702,269.7908;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SwitchByFaceNode;38;152.303,-316.2092;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;-34.36372,-119.8759;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-34,-363.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;36;140.303,247.7908;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;39;-307.3637,-268.8759;Inherit;False;Property;_BackColor;BackColor;4;1;[HDR];Create;True;0;0;0;False;0;False;0.3443396,0.9805411,1,0;0.145098,0.5324502,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;41;-386.3637,-100.8759;Inherit;False;Property;_Backins;Backins;6;0;Create;True;0;0;0;False;0;False;1;2.37;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-386,-344.5;Inherit;False;Property;_Frontins;Frontins;5;0;Create;True;0;0;0;False;0;False;1;1;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;16;-307,-512.5;Inherit;False;Property;_FrontColor;FrontColor;3;1;[HDR];Create;True;0;0;0;False;0;False;0.3443396,0.9805411,1,0;0.1745283,0.321676,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;317,-23;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;FXS_K_Potion_Helix;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638017527909517326;  Blend;0;0;Two Sided;0;638017527892237156;Cast Shadows;0;638017527872289333;  Use Shadow Threshold;0;0;Receive Shadows;0;638017527880521603;GPU Instancing;0;638017527883566350;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=E6360C7914236D085C7045638B5D8825AF40F3F5