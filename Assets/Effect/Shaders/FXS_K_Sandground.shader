...
Shader "FXS_K_Sandground"
{
	Properties
	{
		...
		_Main_Vpanner("Main_Vpanner", Float) = 0.24
		_VMask_Pow("VMask_Pow", Float) = 0
		_Vmask_Mult("Vmask_Mult", Float) = 0
		[ASEEnd]_Sand("Sand", Range( 0 , 1)) = 0.09
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 appendResult16 = (float2(0.0 , _Main_Vpanner));
				float2 uv_MainTex = IN.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 panner13 = ( 1.0 * _Time.y * appendResult16 + uv_MainTex);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = _Tintcolor.rgb;
				float Alpha = ( ( tex2D( _MainTex, panner13 ).r + _Sand ) * saturate( ( pow( ( saturate( ( pow( uv_MainTex.y , 2.78 ) * 1.36 ) ) * ( 1.0 - uv_MainTex.y ) * 4.0 ) , _VMask_Pow ) * _Vmask_Mult ) ) * IN.ase_color.a );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( ( tex2D( _MainTex, panner13 ).r + _Sand ) * saturate( ( pow( ( saturate( ( pow( uv_MainTex.y , 2.78 ) * 1.36 ) ) * ( 1.0 - uv_MainTex.y ) * 4.0 ) , _VMask_Pow ) * _Vmask_Mult ) ) * IN.ase_color.a );
...
/*ASEBEGIN
Version=18935
0;-2;1920;1021;1267;394.5;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-1102,-62.5;Inherit;False;0;10;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-1049,364.5;Inherit;False;Constant;_Float1;Float 1;6;0;Create;True;0;0;0;False;0;False;2.78;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;26;-836,160.5;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-729,242.5;Inherit;False;Constant;_Float2;Float 2;6;0;Create;True;0;0;0;False;0;False;1.36;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-584,159.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;30;-402,188.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-844,519.5;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;18;-850,433.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1149,228.5;Inherit;False;Property;_Main_Vpanner;Main_Vpanner;2;0;Create;True;0;0;0;False;0;False;0.24;0.24;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-568,538.5;Inherit;False;Property;_VMask_Pow;VMask_Pow;3;0;Create;True;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-580,312.5;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;16;-983,177.5;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PowerNode;20;-349,326.5;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-333,504.5;Inherit;False;Property;_Vmask_Mult;Vmask_Mult;4;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;13;-838,-29.5;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;10;-635,-59.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;f862f97ef17a2504c953a715421baf56;f862f97ef17a2504c953a715421baf56;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;35;-467,104.5;Inherit;False;Property;_Sand;Sand;5;0;Create;True;0;0;0;False;0;False;0.09;0.45;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-159,348.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;33;-178,-160.5;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;34;-170,20.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;24;41,338.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-384,-282.5;Inherit;False;Property;_Tintcolor;Tintcolor;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,0.6195262,0.2688679,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;58,38.5;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;180,-22;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;FXS_K_Sandground;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637997816157675428;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;637997816162349049;  Use Shadow Threshold;0;0;Receive Shadows;0;637997816166969001;GPU Instancing;0;637997816164913796;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
WireConnection;25;2;33;4
WireConnection;1;2;11;0
WireConnection;1;3;25;0
ASEEND*/
//CHKSM=F1C950FC62BBACA5B4598C9B33849247C772915C